...
public class bai1 {
    ...
    public static class RatingReducer extends Reducer<Text, Text, Text, Text> {
        ...
        // Class variables to track the highest rated movie
        ...
        public void reduce(Text key, Iterable<Text> values, Context context) throws IOException, InterruptedException {
            ...
            if (count > 0) {
                ...
                // Check if this movie has the highest rating with at least 5 ratings
                if (count >= 5 && avg > maxRating) {
                    maxRating = avg;
                    maxMovie = movieName;
                }

                // Output format: MovieTitle Average rating: xx (Total ratings: xx)
        ...
        protected void cleanup(Context context) throws IOException, InterruptedException {
            if (!maxMovie.isEmpty()) {
                ...
                Text finalValue = new Text(String.format("%s is the highest rated movie with an average rating of %.2f among movies with at least 5 ratings.", maxMovie, maxRating));
